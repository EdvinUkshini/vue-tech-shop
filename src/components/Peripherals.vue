              ...
              <div class="col-12 col-md-3 col-sm-6 col-xs-6 text-center">
                ...
                >
                  <v-img
                    ...
                    height="200px"
                    :src="require('../assets/images/home/deal1.jpg')"
                  >
              ...
              <div class="col-12 col-md-3 col-sm-6 col-xs-6 text-center" >
                ...
                >
                  ...
                  <v-img
                    class="white--text align-end"
                    height="200px"
                    :src="require('../assets/images/home/deal2.jpg')"
                  >
              ...
              <div class="col-12 col-md-3 col-sm-6 col-xs-6 text-center" >
                ...
                >
                  ...
                  <v-img
                    class="white--text align-end"
                    height="200px"
                    :src="require('../assets/images/home/deal3.jpg')"
                  >
              ...
              <div class="col-12 col-md-3 col-sm-6 col-xs-6 text-center" >
                ...
                >
                  ...
                  <v-img
                    class="white--text align-end"
                    height="200px"
                    :src="require('../assets/images/home/deal4.jpg')"
                  >
